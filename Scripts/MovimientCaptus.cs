...
public class MovimientCaptus : MonoBehaviour
{
    ...
    void Update() {
        ...
        if (hitSuperior.collider != null){
            ...
            if (hitSuperior.collider.gameObject.tag == "goblin" && rb.velocity != Vector2.zero && !muerteGoblin){
        ...
        if (hitSuperior2.collider != null) {
            ...
            if (hitSuperior2.collider.gameObject.tag == "goblin" && rb.velocity != Vector2.zero && !muerteGoblin) {
